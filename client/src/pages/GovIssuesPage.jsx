...
import { 
  ...
  MapPin, Camera, X, Upload, Loader2, Play, Search, Filter
} from 'lucide-react';
...
const GovIssuesPage = () => {
  ...
  const [activeTab, setActiveTab] = useState('reported'); // reported, in_progress, resolved
                    ...
                    <div className="flex gap-2">
                       {activeTab === 'reported' && (
                         <button 
                           ...
                           className="flex-1 bg-slate-900 text-white py-2 rounded-lg text-sm font-semibold flex items-center justify-center gap-2"
                         >
